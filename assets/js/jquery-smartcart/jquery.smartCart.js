...
;(function ($, window, document, undefined) {
    ...
    var defaults = {
            ...
            cartItemTemplate: '<div class="Product__image"><img src="{product_image}" /></div><h4 class="Product__name">{product_name}</h4>',
    ...
    function SmartCart(element, options) {
        ...
        // Load from local storage into the cart options
...
// PRIVATE FUNCTIONS
        ...
        _setElements: function () {
            ...
            this.cart_element.addClass('Cart__content');
            this.cart_element.append('<h1 class="Cart__title">' + this.options.lang.cartTitle + ' <span class="Cart__count sc-cart-count">0</span></h1>');
            this.cart_element.append('<div class="Cart__body sc-cart-item-list"></div>');
        },
        /* 
        ...
        _setToolbar: function () {
            ...
            if(this.options.toolbarSettings.showCheckoutButton){
                ...
                switch(this.options.toolbarSettings.checkoutButtonStyle){
                    ...
                    case 'image':
                        ...
                        break;    
                    default:
                        btnCheckout = '<button class="Button sc-cart-checkout" type="button">' + this.options.lang.checkout + '</button> ';
                        break;
                }
            ...
            if(this.options.toolbarSettings.showClearButton){
                var btnClear = $('<button class="Button Button--link sc-cart-clear" type="button">').text(this.options.lang.clear);
            ...
            if(this.options.toolbarSettings.showCartSummary){
                var panelSubTotal = $('<div class="Cart__subtotal sc-cart-summary-subtotal">');
                panelSubTotal.append(this.options.lang.subtotal).append(' <h2 class="Cart__amount sc-cart-subtotal">0</h2>');
         ...
         */
        _addToCart: function (p, saveCart) {
            var mi = this;
            ...
            this._addUpdateCartItem(p, saveCart);
            return p;
        },
        /* 
         ...
         */
        _addUpdateCartItem: function (p, saveCart) {
            ...
            if(elmMain && elmMain.length > 0){
                ...
                elmMain = $('<div></div>').addClass('Product sc-cart-item');
            ...
            this._hasCartChange(saveCart);
        },
        /* 
         * Handles the changes in the cart 
         */
        _hasCartChange: function (saveCart) {
            if (!(saveCart === false)) {
                this._saveCart();
            }
            ...
            switch(this.options.submitSettings.submitType){
                ...
                case 'awslist':
                    ...
                    $.each(this.cart, function( i, p ) {   
                        ...
                        var name = mi._getValueOrEmpty(p[mi.options.paramSettings.productName]);
                        var price = mi._getValueOrEmpty(p[mi.options.paramSettings.productPrice]);
...
// HELPER FUNCTIONS
        ...
        _getContent: function (elm) {
            if(elm.is(":checkbox, :radio")){
                ...
                return elm.attr('src');
            } else if (elm.is('[name="product_image"]')) {
                return elm.attr('style').split("'")[1];
            } else {
                return elm.text();
            }
            return '';
